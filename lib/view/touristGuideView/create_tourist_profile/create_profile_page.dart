          ...
          child: DropdownButton2<String>(
            ...
            value: model.activitiesList.isEmpty
                ...
                : model.activitiesList.any((activity) => activity.isSelect)
                    ...
                    : null,
            onChanged: model.isBusy == true ? null : (value) {},
            style: TextStyle(
                color: AppColor.lightBlack,
                fontFamily: AppFonts.nunitoRegular,
                fontSize: screenHeight * AppSizes().fontSize.simpleFontSize),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            enabled: model.isBusy == false ? true : false,
            textAlignVertical: TextAlignVertical.center,
            textAlign: TextAlign.start,
            style: TextStyle(
                color: AppColor.lightBlack,
